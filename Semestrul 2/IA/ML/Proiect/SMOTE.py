...
train_data = train_data.view(15000, -1)
train_data = np.array(train_data)
train_data = torch.from_numpy(train_data)
train_data, train_labels = oversample.fit_resample(train_data, y)
count0 = 0
count1 = 1
...
print("Len total {}, count0 {}, count1 {}".format(len(train_labels), count0, count1))
train_data = torch.from_numpy(train_data)
