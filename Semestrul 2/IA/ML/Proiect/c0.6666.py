...
# le si normalizam
# norm_x1 = torch.nn.functional.normalize(x, p=1, dim=1)
...
# train_data = torch.nn.functional.normalize(train_data, p = 2, dim = (0,2,3) )
# mean = torch.mean(train_data)
# std = torch.std(train_data)
# train_data = torch.nn.functional.batch_norm(train_data, mean=mean, std=std)
...
# mean = torch.mean(val_data)
# std = torch.std(val_data)
# train_data = torch.nn.functional.normalize(train_data, mean=mean, std=std)
# val_data = torch.nn.functional.normalize(val_data, p=2, dim = (0,2,3))
...
# test_data = torch.nn.functional.normalize(test_data, p=2, dim = (0,2,3))
# mean = torch.mean(test_data)
# std = torch.std(test_data)
# train_data = torch.nn.functional.normalize(test_data, mean=mean, std=std)
